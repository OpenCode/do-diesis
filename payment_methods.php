		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				...
				<div class="span10 main-content">
					...
					<form id="insert_form" class="hide" action="<?php echo __PAYMENT_METHOD_PAGE__; ?>" method="post">
					...
					<form id="search_form" class="<? if ( !$filter ) echo 'hide'; ?>"action="<?php echo __PAYMENT_METHOD_PAGE__; ?>" method="get">
						<div class="controls controls-row">
