<?php
	...
	if ( !$filter) {
		...
		$records = R::find(__GROUP_TABLE__, ' ' . $filter . ' ORDER BY ' . $order_type . ' ');
		}
	...
	<body style="margin-top:10px;">
		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				...
				<div class="span2">
					<?php echo $Template->get_sidebar_nav('groups'); ?>
				</div>
				...
				<div class="span10 main-content">
					...
					<form action="<?php echo __GROUP_PAGE__; ?>" method="get">
						<div class="controls controls-row">
					...
					<?php
						...
						if ( count($records) ) {
							...
							foreach( $records as $r ) {
								...
								if ( R::findOne(__MAIN_TABLE__,' group_id = ? ',array($r['id'])) ) {
