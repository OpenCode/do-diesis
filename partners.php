<?php
	...
	if ( $_POST ) {
		if ( isset($_POST['line_id']) && $_POST['line_id'] != '0' ) {
			$main = R::load(__PARTNER_TABLE__, $_POST['line_id']);
			}
		else {
		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				...
				<div class="span10 main-content">
					...
					<form id="search_form" action="<?php echo __PARTNER_PAGE__; ?>" method="get">
			...
			<div id="insert_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<form id="insert_form" action="<?php echo __PARTNER_PAGE__; ?> " method="post">
